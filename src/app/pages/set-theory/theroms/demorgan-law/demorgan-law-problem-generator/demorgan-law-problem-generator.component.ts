...
@Component({
  selector: 'app-demorgan-law-problem-generator',
  imports: [
    MatCardModule,
    MatInputModule,
    MarkdownComponent,
  ...
  templateUrl: './demorgan-law-problem-generator.component.html',
  styleUrl: './demorgan-law-problem-generator.component.scss'
})
export class DemorganLawProblemGeneratorComponent {
  @Output() answerSender = new EventEmitter<DemorgansLawProblem[]>();
  generatedProblems: DemorgansLawProblem[] = [];
  ...
  private generateMembershipProblem(): DemorgansLawProblem {
